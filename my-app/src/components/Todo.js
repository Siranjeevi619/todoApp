                  ...
                  {inputFieldVisible ? (
                    <div className=''>
                      ...
                      <div className=' my-3 d-flex align-items-center justify-justify-content-center '>
                        ...
                        <button className='btn add-btn  mx-3' onClick={() => inputFieldVisible = false}>ViewList <i class="bi bi-list-nested"></i></button>
                      </div>
                    </div>
                  ) : (
                    <div className=''>
                      ...
                      <div className='d-flex justify-content-center mt-4'>
                        <button onClick={() => inputFieldVisible = true} className='btn btn-color shadow'>Back <i class="bi bi-back"></i></button>
                      </div>
                    </div>
                  )}
                </div>
